/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bfe704ae2b9c826d42b59c8c05197527)
// Runtime types generated with workerd@1.20260526.1 2025-08-07 nodejs_compat
interface __BaseEnv_Env {
	DISCORD_PUBLIC_KEY: string;
	DISCORD_APPLICATION_ID: string;
	DISCORD_TOKEN: string;
	DISCORD_TEST_GUILD_ID: string;
	KAKAO_REST_API_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_PUBLIC_KEY" | "DISCORD_APPLICATION_ID" | "DISCORD_TOKEN" | "DISCORD_TEST_GUILD_ID" | "KAKAO_REST_API_TOKEN">> {}
}
